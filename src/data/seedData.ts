...
export const SEED_STORIES: Story[] = [
  ...
  {
    id: 'story-education-nelfund-disbursement-2026',
    clusterId: 'cluster_20260815_education_nelfund',
    headline: 'NELFUND Disburses ₦35 Billion in Student Loans and Upkeep Stipends to Over 180,000 Undergraduates Across Federal Universities',
    summary: 'The Nigerian Education Loan Fund (NELFUND) has disbursed tuition fees and monthly living stipends directly to institutional accounts and student beneficiary e-wallets across 45 federal tertiary institutions.',
    keyPoints: [
      'Over ₦35 billion disbursed in phase-one rollouts directly covering full institutional tuition and living upkeep allowances.',
      'NELFUND Managing Director confirms zero-collateral, zero-interest terms for eligible public university, polytechnic, and college of education students.',
      'National Universities Commission (NUC) and ASUU leadership commend automated transparent digital screening portals.',
      'State-owned tertiary institutions slated for onboarding in subsequent deployment tranche next month.'
    ],
    whatHappened: 'At a status briefing at the Ministry of Education in Abuja, NELFUND executive management released empirical metrics demonstrating the seamless processing and disbursement of student loans across all six geopolitical zones.',
    mainStory: 'The initiative, established under the Access to Higher Education Act, ensures that no qualified Nigerian youth is denied tertiary education due to economic circumstance.\n\nAccording to official documentation verified from The Punch and Vanguard News, institutional tuition fees are paid directly to participating university bursaries, while monthly living stipends are remitted directly to students’ commercial bank accounts and verified BVN profiles.\n\nStudent union executives at the University of Lagos (UNILAG), Ahmadu Bello University (ABU), and the University of Nigeria Nsukka (UNN) have reported high student satisfaction with the turnaround time of the digital loan portal.',
    background: 'The Federal Government restructured the student loan scheme in 2024 to simplify qualification benchmarks and remove guarantor bottlenecks.',
    whatHappensNext: 'Applications for state university undergraduates and vocational training colleges will open nationwide on the central portal on September 1st.',
    article: '',
    category: 'Education',
    tags: ['Education', 'NELFUND', 'Student Loan', 'Universities', 'The Punch', 'ASUU'],
    slug: 'nelfund-disburses-35bn-student-loans-180k-undergraduates',
    image: 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=1200&auto=format&fit=crop&q=80',
    imageCaption: 'Nigerian university students on campus following the commencement of NELFUND disbursement.',
    imageCredit: 'The Punch Education Bureau / Abuja Desk',
    ...
    requiresReview: false,
    primarySourceName: 'The Punch',
    primarySourceUrl: 'https://punchng.com/topics/education/nelfund-disburses-35bn-student-loans-undergraduates/',
    sources: [
      {
        sourceId: 'src-punch-ng',
        sourceName: 'The Punch',
        sourceUrl: 'https://punchng.com/topics/education/nelfund-disburses-35bn-student-loans-undergraduates/',
      ...
      },
      {
        sourceId: 'src-vanguard-ngr',
        sourceName: 'Vanguard News',
        sourceUrl: 'https://www.vanguardngr.com/category/education/nelfund-commences-direct-stipend-payments/',
        publishedAt: new Date(Date.now() - 55 * 60000).toISOString(),
        relationship: 'secondary'
      }
    ],
    seoTitle: 'NELFUND Disburses ₦35B in Student Loans to 180k Students | The Punch',
    metaDescription: 'NELFUND releases ₦35 billion for tuition and student upkeep across 45 federal universities and polytechnics.',
    canonicalUrl: 'https://nigerianainewshub.ng/news/education/nelfund-disburses-35bn-student-loans-180k-undergraduates',
    aiModelUsed: 'gemini-3.7-flash',
    aiProcessingTimeMs: 1050
  },
  {
    id: 'story-tech-fintech-crossborder-2026',
    clusterId: 'cluster_20260815_tech_fintech',
    headline: 'Nigerian Fintechs Surpass $2.4B in Cross-Border Intra-African Trade Settlements Following PAPSS Integration',
    summary: 'Nigerian digital financial institutions and payment gateways processed over $2.4 billion in intra-African commercial transactions in the second quarter, leveraging local currency settlement channels.',
    keyPoints: [
      'Interswitch, Flutterwave, and Paystack report exponential surge in merchant settlements with Ghana, Kenya, and Egypt.',
      'Integration with the Pan-African Payment and Settlement System (PAPSS) allows direct Naira-to-Cedi/Shilling transactions.',
      'Fintech ecosystem growth reinforces Nigeria’s standing as Africa’s premier financial technology hub.',
      'Central Bank of Nigeria issues updated open banking API security standards to protect cross-border consumer transactions.'
    ],
    whatHappened: 'Quarterly transaction data published by electronic payment switch operators highlights a record 64% year-on-year surge in cross-border e-commerce settlements processed by Nigerian tech platforms.',
    mainStory: 'By eliminating reliance on third-party offshore correspondent banking clearing houses, Nigerian digital merchants and exporters now receive instant settlement in local currencies.\n\nIndustry leaders speaking at the Lagos Fintech Week emphasized that sovereign payment rail interoperability has cut cross-border transaction fees by up to 70%, unlocking new market access for small and medium enterprises across the continent.',
    background: 'The African Continental Free Trade Area (AfCFTA) established PAPSS to boost intra-African trade and mitigate foreign currency liquidity pressures.',
    whatHappensNext: 'The Nigerian Communications Commission (NCC) and CBN will expand 5G infrastructure connectivity across key commercial export ports to ensure uninterrupted fintech settlement latency.',
    article: '',
    category: 'Technology',
    tags: ['Tech', 'Fintech', 'Flutterwave', 'Interswitch', 'Lagos', 'Vanguard'],
    slug: 'nigerian-fintechs-surpass-2-4b-cross-border-trade',
    image: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=1200&auto=format&fit=crop&q=80',
    imageCaption: 'Software engineers and product managers at a high-growth fintech hub in Yaba, Lagos.',
    imageCredit: 'Vanguard Technology Desk',
    publishedAt: new Date(Date.now() - 90 * 60000).toISOString(),
    ...
    requiresReview: false,
    primarySourceName: 'Vanguard News',
    primarySourceUrl: 'https://www.vanguardngr.com/category/technology/nigerian-fintechs-cross-border-volume-record/',
    sources: [
      {
        sourceId: 'src-vanguard-ngr',
        sourceName: 'Vanguard News',
        sourceUrl: 'https://www.vanguardngr.com/category/technology/nigerian-fintechs-cross-border-volume-record/',
        publishedAt: new Date(Date.now() - 95 * 60000).toISOString(),
        relationship: 'primary'
      }
    ],
    seoTitle: 'Nigerian Fintechs Settle $2.4B in Intra-African Trade | Vanguard',
    metaDescription: 'Nigerian fintechs record $2.4 billion in cross-border settlements across West and East Africa in Q2.',
    canonicalUrl: 'https://nigerianainewshub.ng/news/technology/nigerian-fintechs-surpass-2-4b-cross-border-trade',
    aiModelUsed: 'gemini-3.7-flash',
    aiProcessingTimeMs: 980
  },
  {
    id: 'story-ent-nollywood-global-box-office-2026',
    clusterId: 'cluster_20260815_ent_nollywood',
    headline: 'Nollywood Shatters Global Streaming and Cinema Records with ₦4.2 Billion International Box Office Run',
    summary: 'Nigerian cinematic productions have registered unprecedented commercial returns across domestic cinema circuits and premier global streaming networks, grossing ₦4.2 billion over the past quarter.',
    keyPoints: [
      'Indigenous historical epics and modern psychological thrillers lead box office charts in Nigeria, UK, US, and Ghana.',
      'National Film and Video Censors Board (NFVCB) reports 48% growth in international co-production licensing agreements.',
      'Lagos State Creative Arts Fund grants initial capital infusions to 60 emerging Nigerian screenwriters and directors.',
      'Afrobeats original soundtracks produced in Lagos achieve multi-territory platinum certifications.'
    ],
    whatHappened: 'Industry executives and leading Nollywood filmmakers gathered at the Eko Convention Centre in Victoria Island, Lagos, celebrating the phenomenal global expansion of Nigerian film and television content.',
    mainStory: 'With increased investment in high-definition digital cameras, advanced sound design, and localized storytelling, Nigerian cinema is commanding top billing in premier international film festivals and global streaming catalogs.\n\nCultural analysts highlight that the synergy between Nigeria’s music industry and Nollywood storytelling has created a powerful creative economy generating thousands of skilled jobs across production, VFX, and distribution.',
    background: 'Nigeria’s creative industries currently contribute over 2.5% to national GDP, ranking among the world’s most prolific film production hubs.',
    whatHappensNext: 'The Federal Ministry of Art, Culture and the Creative Economy will host the African Creative Summit in Abuja next month to finalize intellectual property protection protocols.',
    article: '',
    category: 'Entertainment',
    tags: ['Nollywood', 'Entertainment', 'Box Office', 'Lagos', 'Premium Times', 'Cinema'],
    slug: 'nollywood-shatters-global-box-office-records-4-2bn',
    image: 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=1200&auto=format&fit=crop&q=80',
    imageCaption: 'The premiere of an acclaimed Nigerian feature film in Lagos.',
    imageCredit: 'Premium Times Entertainment Desk',
    publishedAt: new Date(Date.now() - 110 * 60000).toISOString(),
    ...
    requiresReview: false,
    primarySourceName: 'Premium Times',
    primarySourceUrl: 'https://www.premiumtimesng.com/entertainment/nollywood-grosses-4-2bn-global-box-office/',
    sources: [
      {
        sourceId: 'src-premium-times',
        sourceName: 'Premium Times',
        sourceUrl: 'https://www.premiumtimesng.com/entertainment/nollywood-grosses-4-2bn-global-box-office/',
        publishedAt: new Date(Date.now() - 115 * 60000).toISOString(),
        relationship: 'primary'
      }
    ],
    seoTitle: 'Nollywood Shatters Global Box Office Records with ₦4.2B | Premium Times',
    metaDescription: 'Nollywood achieves record ₦4.2 billion international box office run across streaming and cinemas.',
    canonicalUrl: 'https://nigerianainewshub.ng/news/entertainment/nollywood-shatters-global-box-office-records-4-2bn',
    aiModelUsed: 'gemini-3.7-flash',
    aiProcessingTimeMs: 910
  }
];
